...
boid_size = (8, 10)
max_speed = 3
neighbor_range = 256 # pixels
separation_range = boid_size[0] + 4 # pixels
...
class Boid:
    def __init__(self):
        ...
        self.vel = [(random.random() - 0.5) * max_speed, (random.random() - 0.5) * max_speed]
        self.neighbors = []
    ...
    def apply_force_from_point(self, point, mag):
        # print(f"point: {point}, self.pos: {self.pos}, mag: {mag}")
    ...
    def alignment(self, neighbors):
        ...
        avg_direction[0] /= len(neighbors)
        avg_direction[1] /= len(neighbors)
